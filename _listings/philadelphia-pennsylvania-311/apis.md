...
x-slug: philadelphia-pennsylvania-311
description: Philly311s goal is to provide world-class service for all our channels-phone,email,mobile,web
  ...
  updates and accurate information. By working closely with city departments, we develop
  valuable insights that help to improve our city.
...
- type: x-twitter
  url: https://twitter.com/philly311
- type: x-website
  url: http://www.phila.gov/311/pages/default.aspx
include: []
maintainers:
- FN: Kin Lane
